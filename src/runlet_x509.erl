...
signature_algorithm(X509) ->
    sigalg(X509#'OTPCertificate'.tbsCertificate#'OTPTBSCertificate'.signature#'SignatureAlgorithm'.algorithm).
...
sigalg(?'id-dsa-with-sha1') -> "dsa-with-sha1";
sigalg(?'id-dsaWithSHA1') -> "dsaWithSHA1";
sigalg(?'md2WithRSAEncryption') -> "md2WithRSAEncryption";
sigalg(?'md5WithRSAEncryption') -> "md5WithRSAEncryption";
sigalg(?'sha1WithRSAEncryption') -> "sha1WithRSAEncryption";
sigalg(?'sha-1WithRSAEncryption') -> "sha-1WithRSAEncryption";
sigalg(?'sha224WithRSAEncryption') -> "sha224WithRSAEncryption";
sigalg(?'sha256WithRSAEncryption') -> "sha256WithRSAEncryption";
sigalg(?'sha512WithRSAEncryption') -> "sha512WithRSAEncryption";
sigalg(?'ecdsa-with-SHA1') -> "ecdsa-with-SHA1";
sigalg(Alg) ->
